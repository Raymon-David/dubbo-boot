...
import com.raymon.provider.dao.user.PermissionPojoMapper;
...
public class PermissionServiceImpl implements PermissionService{
    ...
    @Autowired
    PermissionPojoMapper permissionMapper;
    @Autowired
    ...
    @Override
    public UPermissionPojo insert(UPermissionPojo record) {
        permissionMapper.insert(record);
        return record;
    }

    @Override
    public UPermissionPojo insertSelective(UPermissionPojo record) {
        //添加权限
    ...
    @Override
    public UPermissionPojo selectByPrimaryKey(Long id) {
        return permissionMapper.selectByPrimaryKey(id);
    }

    @Override
    public int updateByPrimaryKey(UPermissionPojo record) {
        return permissionMapper.updateByPrimaryKey(record);
    }

    @Override
    public int updateByPrimaryKeySelective(UPermissionPojo record) {
    ...
    public Map<String, Object> deletePermissionById(String ids) {
        ...
        try {
            ...
            for (String idx : idArray) {
                ...
                List<URolePermissionPojo> rolePermissions= rolePermissionMapper.findRolePermissionByPid(id);
...
//    @Override
//    public Pagination<UPermissionPojo> findPage(Map<String,Object> resultMap, Integer pageNo,
//                                            Integer pageSize) {
            ...
            if(StringUtils.isNotBlank(ids)){
                ...
                for (String pid : idArray) {
                    ...
                    if(StringUtils.isNotBlank(pid)){
                        URolePermissionPojo entity = new URolePermissionPojo(roleId,new Long(pid));
