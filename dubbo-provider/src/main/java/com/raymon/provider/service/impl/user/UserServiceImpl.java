...
public class UserServiceImpl extends BaseMybatisDao<UserMapper> implements UserService {
	...
	@Override
	public Pagination<com.raymon.api.pojo.user.User> findByPage(Map<String, Object> resultMap,
	...
	@SuppressWarnings("unchecked")
	@Override
	public Pagination<UserRoleAllocationPojo> findUserAndRole(ModelMap modelMap,
															  Integer pageNo, Integer pageSize) {
