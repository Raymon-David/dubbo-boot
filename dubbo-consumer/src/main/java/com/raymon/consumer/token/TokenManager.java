...
import com.raymon.consumer.session.CustomSessionManager;
...
public class TokenManager {
     ...
     * @return
     */
    public static UserPojo getToken(){
        UserPojo token = (UserPojo) SecurityUtils.getSubject().getPrincipal();
        return token ;
    }
     ...
     * @return
     */
    public static UserPojo login(UserPojo user,Boolean rememberMe){
